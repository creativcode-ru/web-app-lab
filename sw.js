...
/*
 PWA не должен отображать сообщение об ошибке браузера, в котором говорится, 
 что механизм веб-рендеринга не может загрузить страницу. 
 Вместо этого используйте свой сервис-воркер, чтобы показать свои собственные сообщения, 
 избегая общей и запутанной ошибки браузера.
 */